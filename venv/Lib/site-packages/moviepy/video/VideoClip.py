...
class VideoClip(Clip):
    ...
    def write_videofile(self, filename, fps=None, codec=None,
        ...
        logger(message="ZEUS - Building video %s." % filename)
        if make_audio:
        ...
        if remove_temp and make_audio:
            if os.path.exists(audiofile):
                os.remove(audiofile)
        logger(message="ZEUS - video ready %s" % filename)
    ...
    def write_images_sequence(self, nameformat, fps=None, verbose=True,
        ...
        """
        logger = proglog.default_bar_logger(logger)
        logger(message='ZEUS - Writing frames %s.' % nameformat)
        ...
        logger(message='ZEUS - Done writing frames %s.' % nameformat)
